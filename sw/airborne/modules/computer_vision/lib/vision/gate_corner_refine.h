...
void refine_ogate_corner(struct image_t* im, int *corner_x, int *corner_y, int size, float size_factor, int side);
void ogate_histogram(struct image_t* im, struct opengate_img* opengate, float size_factor, int h_bars[]);